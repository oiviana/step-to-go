        ...
        <div className="flex flex-col-reverse lg:flex-row lg:justify-between">
          ...
          <div>
            ...
            <div className="bottom-[15rem] mt-2 lg:flex items-end lg:h-[378px] min-w-[300px] flex justify-center lg:justify-normal">
              <a
                href="https://drive.google.com/file/d/1JmXwOsGQTlhPGan3HOQivF8264nA1QBw/view?usp=sharing"
                target="_blank"
                className="p-5 h-[60px] flex max-w-[220px] justify-center rounded-md lg:absolute shadow-md font-semibold bg-v-dark-900 dark:bg-v-white-500 text-v-white-300 dark:text-v-dark-bold"
              >
                Veja meu currículo
              </a>
            </div>
