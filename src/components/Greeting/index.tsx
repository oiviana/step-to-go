...
export default function Greeting() {
    ...
    return (
        ...
        >
            <div className="relative w-full overflow-hidden  px-4 py-8 sm:px-6 sm:py-10 lg:px-10 lg:py-7">
                ...
                <div className="relative z-10 flex flex-col items-center text-center">
                    <div className="relative mb-6 flex items-center justify-center">
                        ...
                        <div className="relative h-36 w-36 rounded-full border border-v-green/30 bg-[linear-gradient(135deg,rgba(158,230,85,0.28),rgba(20,18,23,0.18)_58%,rgba(158,230,85,0.24))] p-[3px] sm:h-48 sm:w-48 lg:h-52 lg:w-52">
                    ...
                    <h1 className="max-w-[14ch] text-xl font-bold !leading-[48px] tracking-[-0.04em] text-v-white-300 sm:text-3xl lg:text-[2.2rem]">
                    ...
                    <div className="my-6 h-9 w-px bg-gradient-to-b from-transparent via-v-green/45 to-transparent" />
